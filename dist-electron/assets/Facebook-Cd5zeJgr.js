...
function requireFacebook() {
  ...
  class Facebook2 extends import_react.Component {
    constructor() {
      super(...arguments);
  ...
  __publicField(Facebook2, "displayName", "Facebook");
  __publicField(Facebook2, "canPlay", import_patterns.canPlay.facebook);
  __publicField(Facebook2, "loopOnEnded", true);
  return Facebook_1;
}
var FacebookExports = /* @__PURE__ */ requireFacebook();
const Facebook = /* @__PURE__ */ getDefaultExportFromCjs(FacebookExports);
