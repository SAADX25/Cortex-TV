...
function requireStreamable() {
  ...
  class Streamable2 extends import_react.Component {
    constructor() {
      super(...arguments);
  ...
  __publicField(Streamable2, "displayName", "Streamable");
  __publicField(Streamable2, "canPlay", import_patterns.canPlay.streamable);
  return Streamable_1;
}
var StreamableExports = /* @__PURE__ */ requireStreamable();
const Streamable = /* @__PURE__ */ getDefaultExportFromCjs(StreamableExports);
