...
function requireFilePlayer() {
  ...
  class FilePlayer2 extends import_react.Component {
    constructor() {
      super(...arguments);
  ...
  __publicField(FilePlayer2, "displayName", "FilePlayer");
  __publicField(FilePlayer2, "canPlay", import_patterns.canPlay.file);
  return FilePlayer_1;
}
var FilePlayerExports = /* @__PURE__ */ requireFilePlayer();
const FilePlayer = /* @__PURE__ */ getDefaultExportFromCjs(FilePlayerExports);
