...
function requireWistia() {
  ...
  class Wistia2 extends import_react.Component {
    constructor() {
      super(...arguments);
    ...
    load(url) {
      ...
      (0, import_utils.getSDK)(SDK_URL, SDK_GLOBAL).then((Wistia22) => {
        if (config.customControls) {
          config.customControls.forEach((control) => Wistia22.defineControl(control));
        }
  ...
  __publicField(Wistia2, "displayName", "Wistia");
  __publicField(Wistia2, "canPlay", import_patterns.canPlay.wistia);
  __publicField(Wistia2, "loopOnEnded", true);
  return Wistia_1;
}
var WistiaExports = /* @__PURE__ */ requireWistia();
const Wistia = /* @__PURE__ */ getDefaultExportFromCjs(WistiaExports);
