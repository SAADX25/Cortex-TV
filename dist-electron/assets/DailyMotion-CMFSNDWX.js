...
function requireDailyMotion() {
  ...
  class DailyMotion2 extends import_react.Component {
    constructor() {
      super(...arguments);
  ...
  __publicField(DailyMotion2, "displayName", "DailyMotion");
  __publicField(DailyMotion2, "canPlay", import_patterns.canPlay.dailymotion);
  __publicField(DailyMotion2, "loopOnEnded", true);
  return DailyMotion_1;
}
var DailyMotionExports = /* @__PURE__ */ requireDailyMotion();
const DailyMotion = /* @__PURE__ */ getDefaultExportFromCjs(DailyMotionExports);
